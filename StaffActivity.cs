...
namespace TipnessAndroid
{
    ...
    public class StaffActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        string FName = "";
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_staffmain);
        ...
        public bool OnNavigationItemSelected(IMenuItem item)
        {
            ...
            if (id == Resource.Id.activityStatistics)
            {
                ...
                StartActivity(typeof(StaffStatisticsActivity));
            }
            else if (id == Resource.Id.members_List)
            {
                ...
                StartActivity(typeof(StaffListMember));
            ...
            else if (id == Resource.Id.members_Add)
            {
                ...
                //menuTransaction.Commit();
                StartActivity(typeof(StaffAddMembers));
            }
            else if (id == Resource.Id.members_Edit)
            {
                ...
                //menuTransaction.Commit();
                StartActivity(typeof(StaffEditMembers));
            }
            else if (id == Resource.Id.members_Delete)
            {
                ...
                //menuTransaction.Commit();
                StartActivity(typeof(StaffDeleteMembers));
            }
